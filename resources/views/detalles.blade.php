...
<div class="container my-5">
    ...
    @if(session('success'))
        <div class="alert alert-success text-center mb-4 p-3 shadow-sm">
            {{ session('success') }}
        </div>
    @endif

    @if(session('error'))
        <div class="alert alert-danger text-center mb-4 p-3 shadow-sm">
            {{ session('error') }}
        </div>
    @endif
...
{{-- Script opcional para que la alerta desaparezca sola --}}
<script>
    setTimeout(function() {
