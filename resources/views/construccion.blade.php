...
<div class="container my-5 py-5 text-center">
    <div class="row justify-content-center mb-5">
     ...
     <div style="text-align: center; padding: 20px;">
        <img src="{{ asset('img/construccion.png') }}" alt="Página en construcción" style="width: 600px; height: auto;">
    </div>

 <div class= "container my-1 py-3 text center">
        <div class = "row justify-content-center mb-5">
            <class text-dark style = font-size: 1.1rem; line-height: 1.8;>
                <h1> Ups..... :( Parecé que a nuestro maestro lo durmieron en el entrenamiento. Volve más adelante mientras limpiamos el tatami
                </h1>
            </div>
        </div>
