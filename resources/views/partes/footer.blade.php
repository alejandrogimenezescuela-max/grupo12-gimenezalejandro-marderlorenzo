<footer class="info-banner mt-5 py-4" style="background-color: #808080;">
    <div class="container">
        <div class="row align-items-start">
            ...
            <div class="col-md-3 text-start">
                <div class="mb-1">
                    <a href="https://www.argentina.gob.ar/economia/industria-y-comercio/defensadelconsumidor" target="_blank" class="text-white text-decoration-none small">Defensa del consumidor</a>
                </div>
                <div class="mb-1">
                    <a href="{{ url('/contacto') }}" class="text-white text-decoration-none small">Contactanos</a>
                </div>
            </div>
